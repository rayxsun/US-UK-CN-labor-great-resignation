...
country <- c(countrybel,Denmark,Germany,Ireland,Greece,Spain,France, Italy,Netherlands,Finland,Sweden,Iceland,Norway,Switzerland,United_Kingdom)
```
...
#combine all values
# values columns
values <- c(bel,den,ger,ire,gree,spa,fran,ita,neth,fin,swed,ice,norw,switz,uk)
...
```{r}
# export data
#write.csv(leaveall,"~/Desktop/great resignation/eurostat/new/leavemale.csv", row.names = FALSE)
```
...
```{r}
# export data
#write.csv(leaveall,"~/Desktop/great resignation/eurostat/new/leavefemale.csv", row.names = FALSE)
```
